              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (contex) => CategoriesScreen("Motor")));
                },
                child: Container(
                ...
                InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => VerTodos(nombreSlide)));
                    },
                    child: Text(
                      "Ver todos",
                      style: TextStyle(
